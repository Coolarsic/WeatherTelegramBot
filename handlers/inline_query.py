import json
import requests
from aiogram.types import InlineQueryResultArticle, InputTextMessageContent, InlineQuery, ParseMode
...
async def inline(query: InlineQuery):
    try:
        ...
        query_answer = InlineQueryResultArticle(
            ...
            input_message_content=InputTextMessageContent(
                message_text=f"<b>Что-то пошло не так. Проверьте корректность названия города</b>" + SAD_ART,
